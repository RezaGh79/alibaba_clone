...
class DomesticFlightPage extends StatefulWidget {
  const DomesticFlightPage({Key? key}) : super(key: key);

  @override
  State<DomesticFlightPage> createState() => _DomesticFlightPageState();
}

class _DomesticFlightPageState extends State<DomesticFlightPage> {
  var origin = "";
  var destination = "";
  String? travelDate = "";
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return InkWell(
                ...
                child: ListTile(
                  title: Text(OriginsDestinations.originsDomestic[index],style: const TextStyle(
                    fontFamily: 'font',
                  )),
                ));
          },
                ...
                content: Column(mainAxisSize: MainAxisSize.min, children: [
                  Row(
                      ...
                      children: [
                        ...
                        Text(numberOfAdult.toString(),style: const TextStyle(
                          fontFamily: 'font',
                        )),
                        Card(
                          elevation: 4,
